...
export default async function page({ params: { userEmail, travelId } }: { params: { userEmail: string, travelId: string } }) {
  ...
  return (
    <TravelPageTemplate travelId={travelId} travelData={travelData} />
  )
}